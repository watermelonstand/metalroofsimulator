...
export default function App() {
  ...
  function handleMouseMove(e: React.MouseEvent<HTMLCanvasElement>) {
    ...
    const p = canvasPos(e);
    setPoints((pts) =>
      pts.map((pt, i) => (i === activePoint ? { x: p.x, y: p.y } : pt))
    );
  }
    ...
    >
      <div className="max-w-6xl mx-auto">
        <header className="mb-6 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-600">
              Upload a house photo, outline the roof, and preview colors.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl bg-black text-white text-sm font-semibold shadow hover:opacity-90 disabled:opacity-40"
              disabled={!imgEl}
            >
              Download PNG
            </button>
          ...
          <aside className="lg:col-span-1 space-y-5">
            <section className="bg-white rounded-2xl shadow p-4">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  onClick={undoPoint}
                  disabled={!points.length || isClosed}
              ...
              <p className="text-xs text-gray-500 mt-2">
                Tip: Click to add points. Drag handles to refine. Double‑click
                to close.
              </p>
            </section>
            ...
            <section className="bg-white rounded-2xl shadow p-4">
              ...
              <div className="mt-3 text-sm text-gray-600">
                ...
                <span className="font-medium">
                  {SW_COIL_COLORS.find((c) => c.hex === color)?.name}
                </span>
              </div>
            </section>
            ...
            <section className="bg-white rounded-2xl shadow p-4">
              ...
              <ul className="text-sm text-gray-600 list-disc pl-5 space-y-1">
                ...
                <li>
                  Use higher blend for deeper color, lower to keep more of the
                  roof’s original tone.
                </li>
                <li>
                  Extend the color list in <code>SW_COIL_COLORS</code>.
                </li>
              </ul>
            </section>
          </aside>
        ...
        <footer className="mt-8 text-xs text-gray-500">
          On‑screen colors are for visualization only and may not match
          manufactured finishes exactly.
        </footer>
      </div>
    </div>
  );
